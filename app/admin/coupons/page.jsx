...
export default function AdminCoupons() {
    ...
    const fetchCoupons = async () => {
        try {
            ...
            const {data}=await axios.get('/api/admin/coupons',{headers:{Authorization:`Bearer ${token}`}})
    ...
    const handleAddCoupon = async (e) => {
        ...
        try {
            ...
            const {data}=await axios.post('/api/admin/coupons',{coupon:newCoupon},{headers:{Authorization:`Bearer ${token}`}})
